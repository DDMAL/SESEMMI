...
class Settings(BaseSettings):
    ...
    sparql_max_attempts: int = (
        2  # total execute tries for transient (timeout/429) failures
    )
    sparql_retry_backoff: float = (
        2.0  # seconds between retries; ≥1 keeps WDQS under 1 RPS
    )
